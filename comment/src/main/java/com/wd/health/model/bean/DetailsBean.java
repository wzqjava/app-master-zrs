...
/**
 * 作者:毛佳翔 by Administor on 2019/8/8 10:47
...
public class DetailsBean {
     ...
     * sickCircleId : 988
     * title : 11
     * treatmentEndTime : 1564761600000
     * treatmentHospital : 的分水电费
     * treatmentProcess : 地方
     * treatmentStartTime : 1559491200000
     */
    ...
    public String toString() {
        return "DetailsBean{" +
                "adoptComment='" + adoptComment + '\'' +
                ", adoptCommentId=" + adoptCommentId +
                ", adoptFlag=" + adoptFlag +
                ", adoptHeadPic='" + adoptHeadPic + '\'' +
                ", adoptNickName='" + adoptNickName + '\'' +
                ", amount=" + amount +
