package com.wd.health.core.screen;
...
public class ScreenAdapter {
     ...
     *
     * @param application
     * @param designSize  设计图大小
     * @param matchBase   匹配基准 MATCH_BASE_WIDTH MATCH_BASE_HEIGHT
     * @param matchUnit   匹配单位 MATCH_UNIT_DP MATCH_UNIT_PT
     */
